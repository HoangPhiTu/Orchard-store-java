...
interface ConcentrationTableToolbarProps {
  search: string;
...
export function ConcentrationTableToolbar({
  search,
  onSearchChange,
  statusOptions,
  onAddConcentration,
  pageSize,
  onPageSizeChange,
}: ConcentrationTableToolbarProps) {
  const { t } = useI18n();
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-border bg-card/90 p-4 md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-3">
        ...
        <Button onClick={onAddConcentration} className="h-10 rounded-lg">
