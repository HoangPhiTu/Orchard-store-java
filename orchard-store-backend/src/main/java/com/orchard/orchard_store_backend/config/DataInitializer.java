...
//      * Tài khoản này sẽ có quyền cao nhất là SUPER_ADMIN
//      */
//     private void createDefaultAdminAccount() {
//         // Thông tin tài khoản admin mặc định
//         String adminEmail = "admin@orchardstore.com";
//         String adminPassword = "SuperAdmin@2024";
//         String adminFullName = "Super Administrator";
...
//             // 2. Tìm Role SUPER_ADMIN (ưu tiên cao nhất)
...
//                     .orElseGet(() -> {
//                         logger.warn("⚠️ SUPER_ADMIN role not found, creating it...");
//                         try {
//                             String superAdminPermissionsJson = "{\"*\": [\"*\"]}";
//                             Map<String, Object> superAdminPermissions = parseJsonToMap(superAdminPermissionsJson);
                            
//                             Role newSuperAdminRole = Role.builder()
//                                     .roleCode("SUPER_ADMIN")
//                                     .roleName("Super Administrator")
//                                     .description("Full system access with all permissions")
//                                     .hierarchyLevel(10) // Level cao nhất
...
//                         } catch (Exception e) {
//                             logger.error("❌ Failed to create SUPER_ADMIN role: {}", e.getMessage());
//                             throw new RuntimeException("Cannot create SUPER_ADMIN role", e);
//                         }
//                     });
            
//             logger.info("✅ Using admin role: {} ({})", adminRole.getRoleName(), adminRole.getRoleCode());
            
//             // 3. Tạo User với SUPER_ADMIN role
//             User admin = User.builder()
//                     .email(adminEmail)
//                     .password(passwordEncoder.encode(adminPassword))
//                     .fullName(adminFullName)
//                     .phone(adminPhone)
//                     .avatarUrl(null) // Avatar URL sẽ được set sau khi upload
//                     .role(User.LegacyRole.ADMIN) // Legacy role (backward compatibility)
//                     .primaryRole(adminRole) // Primary role: SUPER_ADMIN
...
//                         // Cập nhật primary_role_id nếu chưa có hoặc không phải SUPER_ADMIN
//                         if (existingUser.getPrimaryRole() == null || 
//                             !existingUser.getPrimaryRole().getId().equals(adminRole.getId()) ||
//                             !"SUPER_ADMIN".equals(adminRole.getRoleCode())) {
//                             existingUser.setPrimaryRole(adminRole);
//                             existingUser.setUpdatedAt(LocalDateTime.now());
//                             userRepository.save(existingUser);
//                             logger.info("✅ Updated primary role to {} ({}) for admin user", 
//                                     adminRole.getRoleName(), adminRole.getRoleCode());
//                         }
//                     } else {
