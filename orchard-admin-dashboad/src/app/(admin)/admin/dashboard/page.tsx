...
const statCards = [
  {
    ...
    gradient: "linear-gradient(135deg, #2A4AE4, #6B7CFF)",
    icon: Wallet,
  },
  {
    title: "Total Orders",
    ...
    trend: "up",
    description: "vs last month",
    gradient: "linear-gradient(135deg, #FF9A3C, #FFB347)",
    icon: ShoppingBag,
  },
  {
    title: "New Customers",
    ...
    trend: "up",
    description: "vs last month",
    gradient: "linear-gradient(135deg, #25B78C, #5DE1B3)",
    icon: Users,
  },
  {
    ...
    gradient: "linear-gradient(135deg, #FB5C74, #FF94A8)",
    icon: AlertTriangle,
  },
];
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between text-sm opacity-90">
                  ...
                  <Space
                    size={4}
                    align="center"
                    className={card.trend === "up" ? "text-emerald-200" : "text-red-200"}
                  >
            ...
            <div className="chart-wrapper">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={topProducts}>
                  ...
                  <YAxis tickLine={false} axisLine={false} />
                  <Tooltip />
                  <Bar dataKey="sales" radius={[12, 12, 0, 0]} fill="#FF9A3C" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Card>
