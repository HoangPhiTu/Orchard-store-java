# 📚 Documentation Index - Orchard Store
...
| Document                                                 | Description                                | Pages | Status |
| -------------------------------------------------------- | ------------------------------------------ | ----- | ------ |
| **[ARCHITECTURE.md](./backend/ARCHITECTURE.md)**         | Tech stack, Modular Monolith, patterns     | 20    | ✅     |
| **[DATABASE.md](./backend/DATABASE.md)**                 | 40+ tables, ERD diagrams, Hybrid EAV       | 30    | ✅     |
| **[API_REFERENCE.md](./backend/API_REFERENCE.md)**       | 14 API endpoints (Auth & User)             | 20    | ✅     |
| **[HIERARCHY_LEVELS.md](./backend/HIERARCHY_LEVELS.md)** | RBAC hierarchy system                      | 8     | ✅     |
| **[JSONB_GUIDE.md](./backend/JSONB_GUIDE.md)**           | JSONB usage & optimization                 | 18    | ✅     |
| **[MIGRATION_GUIDE.md](./backend/MIGRATION_GUIDE.md)**   | Flyway best practices                      | 12    | ✅     |
| **[MINIO_GUIDE.md](./backend/MINIO_GUIDE.md)**           | MinIO setup, image upload, troubleshooting | 25    | ✅     |
...
| Document                                          | Description                     | Pages | Status |
| ------------------------------------------------- | ------------------------------- | ----- | ------ |
| **[STRUCTURE.md](./frontend/STRUCTURE.md)**       | Directory structure, App Router | 20    | ✅     |
| **[CODING_RULES.md](./frontend/CODING_RULES.md)** | Coding standards, patterns      | 25    | ✅     |
...
| Document                                                | Description                  | Pages | Status |
| ------------------------------------------------------- | ---------------------------- | ----- | ------ |
| **[error-handling.md](./guides/error-handling.md)**     | handleApiError utility guide | 15    | ✅     |
| **[mutation-hook.md](./guides/mutation-hook.md)**       | useAppMutation hook guide    | 20    | ✅     |
| **[refactoring.md](./guides/refactoring.md)**           | Refactor guide (5 steps)     | 15    | ✅     |
| **[coding-standards.md](./guides/coding-standards.md)** | Complete coding standards    | 5     | ✅     |
...
- ✅ Future-proof mutation hook
- ✅ Backend architecture (Modular Monolith)
- ✅ Database schema (40+ tables, ERD)
- ✅ Frontend structure (App Router)
- ✅ Coding standards (8 core rules)
...
**This is your documentation home. Bookmark this page! 🔖**
